...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn deepseek_provider_omits_reasoning_encrypted_content_and_strips_history() {
    skip_if_no_network!();
    ...
    prompt.input.push(ResponseItem::Reasoning {
        ...
        encrypted_content: Some("encrypted-reasoning".into()),
    });
    prompt.input.push(ResponseItem::Message {
        id: Some("message-id".into()),
        role: "assistant".into(),
    ...
    assert!(
        ...
        "DeepSeek provider should not request reasoning.encrypted_content"
    );
}

#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn deepseek_compatibility_override_enabled_applies_to_generic_provider() {
    skip_if_no_network!();
    ...
    .with_deepseek_compatibility_override(Some(
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn deepseek_compatibility_override_disabled_preserves_reasoning_round_trip() {
    skip_if_no_network!();
    ...
    .with_deepseek_compatibility_override(Some(
        codex_protocol::config_types::DeepSeekCompatibility::Disabled,
    ));
    let mut client_session = client.new_session();
